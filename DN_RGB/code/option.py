...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/data1/lvyalei/dataset/',
...
parser.add_argument('--data_test', type=str, default='Set5',
                    help='test dataset name while training')
...
parser.add_argument('--model', default='MAN',
                    help='model name')
...
# For RNAN
parser.add_argument('--noise_level', default='50',
...
parser.add_argument('--testpath', type=str, default='/media/yulun/10THD1/testdata/Denoising/LQ',
                    help='dataset directory for Demo test')
parser.add_argument('--testset', type=str, default='Kodak24',
                    help='dataset name for test only')
